...
#' to specify using the Duke StatSci College Senior Thesis LaTeX template and cls files.
#'
#' @export
...
#' @return A modified \code{pdf_document} based on the Duke StatSci Senior Thesis LaTeX
#'   template
#' @examples
#' \dontrun{
#'  output: thesisdowndss::thesis_pdf
#' }
...
#' @examples
#' \dontrun{
#'  output: thesisdowndss::thesis_gitbook
#' }
...
#' the Duke StatSci Senior Thesis Word template
#' @examples
#' \dontrun{
#'  output: thesisdowndss::thesis_word
#' }
...
#' @examples
#' \dontrun{
#'  output: thesisdowndss::thesis_epub
#' }
